...
Source0:       esxi-nuage-nova-%{version}.tar.gz
BuildRoot:     %{_tmppath}/esxi-nuage-nova--%{version}-buildroot
Prefix:        /
...
%files
%{python2_sitelib}/esxi_nuage_nova*
